        ...
        <div className="mx-4 lg:mx-6">
          <motion.nav
            ...
            className={`transition-all duration-500 ${isScrolled
              ? 'bg-black/10 dark:bg-white/10 backdrop-blur-2xl border border-black/10 dark:border-white/20 rounded-full px-6 py-3 shadow-xl shadow-black/10 dark:shadow-black/30'
              : 'px-6 py-3'
              }`}
          >
            <div className="flex items-center justify-between">
              <motion.a
                href="#"
                className="text-2xl font-serif font-bold text-gray-900 dark:text-white italic"
